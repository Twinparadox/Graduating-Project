...
def show_train_result(result, val_position, initial_offset):
    ...
    '''
    if val_position == initial_offset or val_position == 0.0:
        logging.info('Episode {}/{} - Train Position: {}  Val Position: USELESS asset:{}'
                     .format(result[0], result[1], format_position(result[2]), format_position(result[3])))
    else:
        logging.info('Episode {}/{} - Train Position: {}  Val Position: {} asset:{}'
                     .format(result[0], result[1], format_position(result[2]), format_position(val_position),
                             format_position(result[3])))
