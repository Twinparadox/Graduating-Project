...
```bash
python train.py stcokdata/SS.csv stockdata/SS_2018.csv data/economy_leading.csv --strategy dqn
```

Once you're done training, run the evaluation script and let the agent make trading decisions:

```bash
python eval.py stockdata/SS_2019.csv data/economy_leading.csv --model-name model_debug_50 --debug
```
